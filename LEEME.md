...
Opciones: número de animales (2 a 1,176), arena (**tierra**, **agua**, **aire** o sorteo por pelea),
velocidad (turbo por lotes, o pelea por pelea para ver la latencia real de cada respuesta),
resultado (gana el favorito, o sorteado con la probabilidad de Jev) y qué tipos participan.

Referencia medida: 1,000 animales en tierra = 999 peleas en ~23 s, 41 llamadas, ~21 ms por decisión, US$ 0.005.
...
- `animales.csv` — 1,176 animales con tipo y clase; se puede editar a mano.
